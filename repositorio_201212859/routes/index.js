...
router.get('/graph', function (req, res) {
    ...
    console.log('Dato1 ' + uso_cpu);
    console.log('Dato2 ' + total_memoria);
    console.log('Dato3 ' + memoria_usada);
    console.log('Dato4 ' + porcentaje_memoria_libre);
